      ...
      <ol start="1" type="1">
        <ol start="1" type="1">
          ...
          <li>
            ...
            Agreement and
            <a href="https://mydukaan.io/privacy">our Policies</a>(
        ...
        <li>
          ...
          <ol start="1" type="1">
            ...
            <li>
              The Plan for this tranche is to purchase INR 6,00,000 broken down
              into 12 equal parts from the Navtatva B2B website from the
              products carousel with payment to be done in 30-40 days of the
              product received ( exclusive of any third party products bought
              from the system). There also has to be 70% of Navtatva product
              listed in the website provided.
            </li>
            <li>
