const TermsCondition3 = () => {
  return (
    <>
      <p>
        These terms and conditions (&ldquo;Terms&rdquo;) and the privacy policy
        (&ldquo;Privacy Policy&rdquo;) (collectively &ldquo;User
        Agreement&rdquo;) forms an electronic record in terms of Information
        Technology Act, 2000 (&ldquo;IT Act&rdquo;) and rules made there
      ...
      <p>
        ...
        Navtatva. Com (including the uniform resource locator created for each
        Merchant) (&ldquo;Website&rdquo;), the mobile application available on
        Play Store and app store- Navtatva i.e. (&ldquo;App&rdquo;) and the
        uniform resource locator created for each Merchant (the
        &lsquo;Website&rsquo;, the &lsquo;App&rsquo; is collectively hereinafter
        referred to as the &ldquo;Platform&rdquo;), operated by&nbsp;Navtatva
        Fashion Private Limited, a company incorporated under the laws of India
        and its registered office at YNO56 57 584THFLOORFLAT 402PLETINUM
        RESIDANCY BHARATIYA ESTATE PARLE POINT SURAT Surat GJ 395007 IN
      </p>
      <p>
        By clicking on the box &ldquo; i agree&rdquo; or by purchasing a
        subscription for the services, you indicate your acceptance of the terms
        and conditions contained in this agreement, in your capacity as a
        legally authorized signatory of your organization (&ldquo;you&rdquo;,
        &ldquo;your&rdquo;, &ldquo;customer&rdquo; or &ldquo;your
        organization&rdquo;). This agreement is entered into between you and
        navtatva fashion private limited, a company registered under the laws of
        india (hereinafter referred to as &ldquo;cloudlytics&rdquo;,
        &ldquo;we&rdquo;, &ldquo;us&rdquo; or &ldquo;our&rdquo; which
        expressions shall include its affiliates, successor in interest, assigns
        and its subsidiaries).&nbsp;
      </p>
      <p>
        You may not access the services if you are our competitor, except with
        our prior written consent. In addition, you may not access the services
        for purposes of monitoring the availability, performance or
        functionality, of the services or for any other benchmarking or
        competitive purposes.
      </p>
      <p>
        We may update this agreement, from time to time and postat our website.
      </p>
      <p>
      ...
      <ol start="1" type="1">
        <ol start="1" type="1">
          <li>
            For the purposes of these Terms, &lsquo;User&rsquo; and wherever the
            context may require, &lsquo;You&rsquo; (or any variation thereof),
            shall mean any natural or legal person (including any legal heirs,
            administrators or successors) who has agreed to become a user of the
            Platform by accessing or using the Platform. If You are accepting
            these Terms and using the Services (<em>as defined below</em>) or
            the Platform on behalf of a company, organization, government, or
            other legal entity, You represent and warrant that You are
            authorized to do so.
          </li>
          <li>
            Unless the context otherwise requires, &ldquo;Growthpond Technology
            Private Limited&rsquo;&rsquo;, &ldquo;We&rdquo;, &ldquo;us&rdquo;,
            &ldquo;our&rdquo; or &ldquo;Company&rdquo; shall
            mean&nbsp;Growthpond Technology Private Limited&nbsp;or any of its
            licensees, whether now or in the future.
          </li>
          <li>
            The Company enables transactions on its Platform between
            participating restaurants/stores/merchants/sellers and buyers,
            dealing in (a) food and beverages, (b) provisions, consumer goods,
            consumables etc., and (c) any other products or services
            (&quot;Platform Services&apos;&apos;). The buyers
            (&quot;Buyers&apos;&apos;) can choose and place orders
          ...
          <li>
            ...
            your &lsquo;acceptance&rsquo;. &lsquo;Acceptance&rsquo; shall mean
            Your affirmative action is on entering information as requested on
            the sign up page or simply by accessing or visiting the Platform. If
            You do not agree or are not willing to be bound by the User
            Agreement and<a href="https://mydukaan.io/privacy">our Policies</a>(
            <em>defined below</em>), please do not enter information as
            requested on the sign up page and click the &ldquo;Accept&rdquo;
            button or do not seek to obtain access to, view, visit, download or
            otherwise use the Platform (or any of its components/constituents)
            or any information or Services.
          </li>
          <li>
            By impliedly or expressly accepting these Terms, You also accept and
            agree to be bound by applicable policies of the Company including
            the Privacy Policy as published on the Platform
            (&ldquo;Policies&rdquo;) communicated to the Users by publication on
            the Platform.
          </li>
          <li>
        ...
        <li>
          ...
          <ol start="1" type="1">
            <li>
              The Company reserves the right to modify the Platform and/or alter
              ...
              and deletion of the account, to anyone who the Company believes
            ...
            <li>
              ...
              that the Company publishes the same on the Platform.
            </li>
            <li>
              The Company shall not be liable to give any prior notice to the
              Users for any amendments to the User Agreement, which in the
              opinion of the Company, has the effect of diminishing the
              User&rsquo;s existing rights or imposing additional obligations.
              You understand and hereby accept that the decision, whether any
              proposed amendments to the User Agreement have the effect of
              diminishing the User&rsquo;s existing rights or imposing
              additional obligations on the User, shall be decided by the
        ...
        <li>
          ...
          <ol start="1" type="1">
            <li>
              &ldquo;Affiliate&rdquo; shall mean any Person who directly or
              indirectly, controls, is controlled by, or is under the common
              control of the Company. The term &ldquo;Control&rdquo; is used in
              the sense of the possession by a Person or a group of Persons
              acting in concert, directly or indirectly, of the right to direct
              or cause the direction of the management and policies of another
              Person, whether through the board of directors or ownership of
              voting rights by such other Person, by the Articles of
              Association, contract or otherwise. A Person or a group of Persons
              acting in concert shall be deemed to be in control of a body
              corporate if such Person or group of Persons is in a position to
              appoint or appoints the majority of the directors of such body
              corporate.
            </li>
            <li>
              &ldquo;Authority&rdquo; shall mean any union, national, state,
            ...
            <li>
              &ldquo;Grievance Redressal Officer&rdquo; means the grievance
              redressal officer appointed by the Company in accordance with
              applicable Law, from time to time.
            </li>
            <li>
              &ldquo;Information&rdquo; means and shall include any confidential
              and/or personally identifiable information or other information
              provided to the Company or other Users of the Platform or at the
              time of registration with the Platform, or through any
              email/messaging feature and shall include without limitation Your
              name, sex, age, email address, mailing address, phone number (if
              provided) or such other personal information.
            </li>
            <li>
              &ldquo;Internal Service Provider&rdquo; shall mean logistics or
              any back end service providers of the Platform appointed by the
              Company that will provide various services that the Company may
              require in order to run operations of the Platform for example to
              facilitate or outsource one or more aspects of the business,
              product and service operations provided on the Platform, including
              search technology, discussion boards, payments, affiliate and
              rewards programs, co-branded credit cards, maintenance services,
              database management etc.
            </li>
            <li>
              &ldquo;Law&rdquo; shall mean all statutes, enactments, acts of
              legislature, laws, ordinances, rules, byelaws, regulations,
              notifications, guidelines, policies, directions, directives and
              orders of any government and or any Authority.
            </li>
            <li>
              &ldquo;Losses&rdquo; shall include, without limitation, losses,
              liabilities, actions, suits, claims, proceedings, costs, damages,
              penalties, judgments, amounts paid in settlement, expenses, etc.
            </li>
            <li>
              &ldquo;Pay Facility&rdquo; means the automated electronic payment
              or collection and remittance facility provided by the Company to
              the Buyers to facilitate payments for paid services on the
              Platform directly through banks or financial institution
              infrastructure or indirectly through payment gateway facility
              providers or through any such facility authorized by the Reserve
              Bank of India to provide enabling support facility for collection
              and remittance of payment.
            </li>
            <li>
              &ldquo;Person&rdquo; shall mean and include any individual, legal
              entity, company, body corporate, partnership firm, association,
              Hindu undivided family, trust, society, limited liability
              partnership or proprietorship, whether incorporated or not.
            </li>
            <li>
              &ldquo;Policies&rdquo; shall mean and include the Privacy Policy
              and any other policies of the Company as amended and provided on
              the Platform or communicated to the Users in any other way from
              time to time.
            </li>
            <li>
              &ldquo;Services&rdquo; shall mean the services rendered by the
              Platform as may be specifically notified by the Company on the
              Platform or by other means of communication from time to time, in
              accordance with the applicable Law, and currently includes acting
              as an intermediary or a facilitator for providing a platform web
              and/or mobile application for enabling the users to sell their
              products or services online.
            </li>
            <li>&ldquo;User(s)&rdquo; shall mean a user of the Platform.</li>
            <li>
              &ldquo;Agreement&rdquo; means this Agreement including all
              attachments, annexes, schedules and other ancillary documents that
              relate to it, as well as any other attachments, annexes, schedules
              and other ancillary documents referred to in this Agreement.
            </li>
            <li>
              &ldquo;Software&rdquo; means the &ldquo;Navtatva Retail 4.0&rdquo;
              SaaS product, along with various tools and services, as more
              specifically described in Schedule A.
            </li>
            <li>
              &ldquo;Subscription&rdquo; means the limited license to use and
              access the Software and Services in line with the Subscription
              Plan purchased by the Customer.
            </li>
            <li>
              &ldquo;Subscription Plan&rdquo; a plan selected by the Customer
              out of the varied types of plans offered by us enabling Customer
              to enjoy different parameters in relation to the Services such as
              (but not limited to) user levels, number of compliance monitors,
              per-defined dashboards etc.
            </li>
            <li>
              &ldquo;Services&rdquo;means services provided by us to you as a
              result of your access and use of the Software. Particulars of the
              Services offered shall depend on Subscription Plan opted for by
              you.
            </li>
            <li>
              The Plan for this tranche is to purchase INR 24,00,000 broken down
              12 equal parts of Navtatva B2B website products carousel with
              payment to be done in 30-40 days of the product received (
              exclusive of any third party products bought from the system).
              There also has to be 40% of Navtatva product listed in the website
              provided.
            </li>
            <li>
              &ldquo;User&rdquo; means an individual who is authorized by you to
              use the Services, for whom you have purchased a Subscription, and
              to whom you (or, when applicable, us at your request) have
              supplied a user identification and password (for Services
              utilizing authentication). Users may include, for example, your
              employees, consultants, contractors and agents, and third parties
        ...
        <li>
          ...
          <ol start="1" type="1">
            ...
            <li>
              The Company shall not be liable in case of any false information
              is provided by the User including User&rsquo;s age and the User
              and/or his natural or appointed guardian alone shall be liable for
              the consequences as per the applicable Law of the country to which
              the User belongs.
            </li>
            <li>
              The Company disclaims all liability arising out of such
              unauthorised use of the Platform and any third party liability
              arising out of Your use of the Platform if You are a minor.
            </li>
          </ol>
        </li>
        <li>
          <strong>Registration and Creation of Profile:</strong>
          <ol start="1" type="1">
            <li>
            ...
            <li>
              ...
              User&rsquo;s account access information and password, if the User
              is registered on the Platform. The User shall be responsible for
              all usage of the User&rsquo;s account and password, whether or not
              authorized by the Merchant.
            </li>
            <li>
              The User shall immediately notify the Company of any actual or
              suspected unauthorized use of the User&rsquo;s account or
              password. Although the Company, its directors, shareholders,
              Affiliates, employees, associates, contractors or agents
              (&ldquo;Personnel&rdquo;) shall not be responsible in any manner
              for any Losses occurring from any breach of secrecy of Your
              username, password, user code or any unauthorized use of Your
              account, and You shall be liable for any Losses suffered by the
        ...
        <li>
          ...
          <ol start="1" type="1">
            ...
            <li>
              ...
              all information deemed &quot;personal&quot; or
              &ldquo;sensitive&rdquo; by applicable Laws, is entirely voluntary
              on Your part.
            </li>
            <li>
            ...
            <li>
              The Company shall not be responsible in any manner whatsoever for
              the authenticity of the personal information or sensitive personal
              data or information supplied by the User to the Company or to any
            ...
            <li>
              ...
              misleading, not current or incomplete or the Company has
              reasonable grounds to believe that such information is untrue,
              inaccurate, misleading, not current or incomplete, or not in
              accordance with the User Agreement, the Company reserves the right
              to indefinitely suspend or terminate or block Your use or access
              to the Platform in any manner whatsoever. Should any other User or
              Person act upon such untrue, inaccurate, not current or incomplete
              information provided or verified by You, the Company, and its
              Personnel shall not be liable for any damages, Losses, direct,
              indirect, immediate or remote, interests or claims resulting from
              such information to You or to any third party. You hereby agree
              and undertake to indemnify and to hold harmless the Company, and
              its Personnel in accordance with the Indemnity clause contained in
              these Terms.
            </li>
            <li>
              Once You have signed up on the Platform, You agree, allow and
              grant the Platform to gain access to Your mobile device to find
              and keep track of mobile phone numbers of other Users of the
              Service, Your location, inbuilt storage or other storage on Your
              mobile device, access to internet, control vibration, accounts on
              Your mobile device and such other data or information downloaded,
              added, edited, stored, processed, used, deleted on or from Your
              mobile device.
            </li>
          </ol>
        </li>
        <li>
          ...
          <ol start="1" type="1">
            <li>
              ...
              the Company. You further agree that Your use of the Platform or
              provision of any data or information including any correspondence
              (by email or otherwise) to or by the Company is through electronic
              records and You consent to receiving communication from the
              Company via electronic documents including emails and/or SMS,
              which will be deemed adequate for service of notice/ electronic
              record.
            </li>
            <li>
              ...
              features of our services. The Company may also send You
              promotional information unless You have opted out of receiving
              such information.
            </li>
            <li>
        ...
        <li>
          ...
          <ol start="1" type="1">
            <li>
              ...
              after sales services related to products and services. The Company
              ...
              Company may, however, offer support services to Merchants in
              respect to Order fulfilment, logistics, mode of payment, payment
              collection and other ancillary services, pursuant to the
              understanding between the Company and the Merchants. The price of
              the products and services offered by the Merchant are solely
              determined by the Merchant itself and the Company has no role to
            ...
            <li>
              ...
              conditions and the Company takes no responsibility for such offers
              or promotions.
            </li>
            <li>
              The Company neither makes any representation or warranty as to
              ...
              services on the Platform. The Company accepts no liability for any
            ...
            <li>
              ...
              of any contract entered into between Buyers and Merchants. The
              Merchant agrees to indemnify the Company for any and all Losses
              suffered by the Company due to Merchant&rsquo;s use of the
              Platform and interactions with Buyers pursuant thereto. The
              Company cannot and does not guarantee that the concerned Buyers
              and Merchants will perform any transaction concluded on the
              Platform. The Company is not responsible for unsatisfactory or
            ...
            <li>
              The Company is operating an online marketplace and assumes the
              ...
              Merchant. At no time shall the Company hold any right, title or
              interest over the products nor shall the Company have any
              obligations or liabilities in respect of such contract entered
              into between Buyer and Merchant.
            </li>
            <li>
              The Company is only providing a platform for communication and it
              ...
              Company&rsquo;s sole responsibility shall be to notify the same to
              the Merchant and shall also redirect the Buyer to the consumer
              call centre of the Merchant. The Merchant shall be solely liable
              for redressing Buyer complaints. In the event You raise any
              complaint on any Merchant accessed using our Platform, we shall
        ...
        <li>
          ...
          <ol start="1" type="1">
            <li>
              The Merchants may list and provide the details of the products/
              services offered for sale to the Buyers as a registered user of
              the Platform, however the Merchants shall not be permitted to sell
              any product that fall are under the list of banned items
              identified by the Company from time to time, or are otherwise
              prohibited for sale under applicable Law.
            </li>
            <li>
            ...
            <li>
              ...
              such case, the Company may suspend your account or permanently
              debar You from accessing the Platform.
            </li>
          </ol>
        </li>
        <li>
          ...
          <ol start="1" type="1">
            <li>
              ...
              <ol start="1" type="1">
                <li>
                  ...
                  <ol start="1" type="1">
                    ...
                    <li>
                      ...
                      person&apos;s copyrighted work (see &quot;copyright
                      complaint&quot; below for instructions on how to lodge a
                      complaint about uploaded copyrighted material), such as
                      providing pirated computer programs or links to them,
                    ...
                    <li>
                      ...
                      selling of products related to the Platform. Throughout
                      these Terms, the Company&rsquo;s prior written consent
                      means a communication coming from the Company&rsquo;s
                    ...
                    <li>
                      ...
                      the Platform or any third party&apos;s user and enjoyment
                      of similar services;
                    </li>
                    <li>
                      refers to any website or URL that, in our sole discretion,
                      contains material that is inappropriate for the Platform
                      or any other website, contains content that would be
                      prohibited or violates the letter or spirit of these
                      Terms;
                    </li>
                    ...
                    <li>
                      ...
                      secrets or rights of publicity or privacy or shall not be
                    ...
                    <li>
                      ...
                      any trojan horses, worms, time bombs, cancelbots, easter
                    ...
                    <li>
                      directly or indirectly, offers, attempts to offer, trades
                      or attempts to trade in any item, the dealing of which is
                ...
                <li>
                  ...
                  transaction which is violative of these Terms or applicable
                  Laws comes to Your knowledge, You shall forthwith take all
                  steps to inform the Company of such violation at
                  legal@navtatva.fashion
                </li>
                <li>
                ...
                <li>
                  ...
                  user of or visitor to Platform, or any other Buyer, including
                  any account on the Platform not owned by You, to its source,
                  or exploit the Platform or any service or information made
                ...
                <li>
                  ...
                  for any purpose that is unlawful or prohibited by the User
                  Agreement, or to solicit the performance of any illegal
                  activity or other activity that infringes the rights of the
                  Company and/or others.
                </li>
                <li>
                  You shall at all times ensure full compliance with the
                  applicable provisions, as amended from time to time, of (a)
                  the Information Technology Act, 2000 and the rules thereunder;
                  (b) all applicable Laws; and (c) international laws, foreign
                  exchange laws, statutes, ordinances and regulations
                  (including, but not limited to sales tax/VAT, income tax,
                  general sales tax, central excise, custom duty, local levies)
                  regarding Your use of our service and Your listing, purchase,
                  solicitation of offers to purchase, and sale of products or
                  services. You shall not engage in any transaction in an item
                  or service, which is prohibited by the provisions of any
                  applicable law including exchange control laws or regulations
                ...
                <li>
                  ...
                  exercise the copyright, publicity, database rights or any
                  ...
                  with these Terms and Policies applicable to use of the
                  Platform.
                </li>
                <li>
                  ...
                  such information shall be complete, accurate and not
                  misleading in all respects. You shall not exaggerate or
                  overemphasize the attributes of such products or services so
                ...
                <li>
                  ...
                  advertise to, solicit, or sell to another person other than us
                  without our prior explicit consent. You understand that we
                  have the right, at all times, to disclose any information
                  (including the identity of the persons providing information
                  or materials on the Platform) as necessary to satisfy any law,
                  regulation or valid governmental request. This may include,
                  without limitation, disclosure of the information in
                  ...
                  expressly authorize us to) disclose any information about You
                  to any law enforcement or other government officials, as we,
                ...
                <li>
                  ...
                  law or either the spirit or letter of these Terms.
                  ...
                  posted does not reflect the Company&rsquo;s views. In no event
                  shall the Company assume or have any responsibility or
                  liability for any content posted or for any claims, damages or
                  Losses resulting from use of content and/or appearance of the
                  ...
                  shall not infringe any proprietary or intellectual property or
                ...
                <li>
                  ...
                  or &apos;hackers&apos;) may post or transmit offensive or
                  obscene materials on the Platform and that You may be
                  involuntarily exposed to such offensive and obscene materials.
                  It is also possible for others to obtain personal information
                  about You due to Your use of the Platform, and that the
                  recipient may use such information to harass or injure You. We
                  do not approve of such unauthorized uses, but by using the
                  Platform You acknowledge and agree that we are not responsible
                  for the use of any personal information that You publicly
            ...
            <li>
              ...
              and expects Users of the Services to do the same. We reserve the
              right to remove content alleged to be infringing without prior
              notice, at our sole discretion, and without any liability to You.
              We will respond to notices of alleged infringement that comply
              with applicable Law and are properly provided to us. If You
              believe that Your content has been copied in a way that
              constitutes copyright infringement, please report this at
              legal@navtatva.fashion
            </li>
            <li>
              The Company may in future charge a fee or charges, as intimated
              from time to time on the Platform, for registration on the
              Platform as Users especially for maintaining an official account,
              for availing services provided by the Company through the
              Platform. Currently, the Company does not levy any charges/fees
              for registration, access or maintaining an account on the
              Platform. The Company reserves the right to introduce new services
              including any premium or paid services or modify or discontinue
              any existing services provided on the Platform. Changes to the
              Terms or any of the Policies of the Company shall be published on
              the Platform and such changes shall automatically become effective
              immediately after they are published on the Platform. You are
              requested to visit the Terms and various Policies links on the
              Platform often to keep abreast of any amendments.
            </li>
            <li>
              ...
              any consent, approval, authorization of Authority required for the
              execution, delivery and performance of its respective obligations
              hereunder. If the Company suffers any Loss or damages or a claim
              is made by any Person against the Company or the Platform as a
              result of a breach or default or contravention on Your part of the
              User Agreement , You agree to, forthwith upon delivery of notice
              by the Company, make good such Losses or damages or claim amounts
            ...
            <li>
              ...
              third party without the specific prito written permission of the
              Company.
            </li>
          </ol>
        </li>
        <li>
          ...
          <ol start="1" type="1">
            <li>
              In case of any violation by You of the User Agreement , the
              Company has the right to immediately terminate the access or usage
              rights of the User to the Platform without any notice and any such
            ...
            <li>
              If the Company terminates Your access to the Platform, the Company
              may, in its sole and absolute discretion, remove and destroy any
              data and files stored by You on its servers and You agree and
              acknowledge that the Company or the Platform shall not in any
              manner be responsible and/or liable for removing or deleting such
              information.
            </li>
          </ol>
        </li>
      ...
      <p>
        We neither endorse any Merchant or the products/services offered by
        them. In addition, although these Terms require You to provide accurate
        Information, we do not attempt to confirm, and do not confirm its
        purported identity. We will not be responsible for any damage or harm
        resulting from Your interactions with Merchants.
      </p>
      <p>
        By using the Services, You agree that any legal remedy or liability that
        You seek to obtain for actions or omissions of Merchants or other third
        parties will be limited to a claim against the particular Merchant or
        other third parties who caused You harm and You agree not to attempt to
        impose liability on, or seek any legal remedy from us with respect to
      ...
      <ol start="13" type="1">
        <li>
          ...
          <ol start="1" type="1">
            ...
            <li>
              The Company disclaims all liability that may arise due to any
            ...
            <li>
              ...
              We and / or our employees make no warranty or representation
              regarding the timeliness, content, sequence, accuracy,
              effectiveness or completeness of any information or data furnished
              hereunder or that the information or data provided hereunder may
              be relied upon. Multiple responses may usually be made available
              from different sources and it is left to the judgement of Users
              based on their specific circumstances to use, adapt, modify or
              alter suggestions or use them in conjunction with any other
              sources they may have, thereby absolving us as well as our
              consultants, business associates, Affiliates, business partners
        ...
        <li>
          ...
          <ol start="1" type="1">
            ...
            <li>
              You recognize that the Company is the registered owner of the word
              mark &lsquo;Navtatva&rsquo; and the logo including but not limited
              to its variants (&ldquo;IPR&rdquo;) and You shall not directly or
              indirectly, attack or assist another in attacking the validity of,
              or Company&rsquo;s or its Affiliates proprietary rights in, the
              licensed marks or any registrations thereof, or file any
              applications for the registration of the licensed marks or any
              names or logos derived from or confusingly similar to the licensed
              marks, any variation thereof, or any translation or
              transliteration thereof in another language, in respect of any
              products/services and in any territory throughout the world. If
              You become aware or acquire knowledge of any infringement of IPR
              You shall report the same at&nbsp;legal@navtatva.fashion&nbsp;with
        ...
        <li>
          ...
          <ol start="1" type="1">
            <li>
              ...
              value (&ldquo;Transaction Fees&rdquo;) to the Company. The
              Merchant agrees that the Transaction Fees is subject to change and
              such change shall be published on the Platform from time to time.
            </li>
            <li>
            ...
            <li>
              ...
              Transaction Fees) in the Merchant&rsquo;s account, within 2
              working days from the Buyer being in receipt of the good/service
              pursuant to such an Order delivered.
            </li>
            <li>
              In order to enable Buyers to use paid services on the Platform,
              the Company facilitates the provision of Pay Facility by a
            ...
            <li>
              ...
              being published on such third party service provider&rsquo;s
              website.
            </li>
            <li>
              ...
              Buyer, the Company shall not be responsible for loss of money, if
              ...
              contact us at
              <a href="mailto:%20support@navtatva.fashion">
                &nbsp;support@navtatva.fashion
              </a>{" "}
            ...
            <li>
              You agree and accept that the Company is neither acting as a
              trustee nor acting in a fiduciary capacity with respect to the
              payment transaction by reason of providing the Pay Facility or any
              other method of payment to its Buyers.
            </li>
            <li>
            ...
            <li>
              ...
              bank as applicable. If Your bank refuses to authorize payment, the
              ...
              where the payment authorization is delayed by Your bank/ financial
              institution.
            </li>
            <li>
            ...
            <li>
              The Merchants have specifically authorized the Company or its
              service providers to collect, process, facilitate and remit
              payments electronically or through &lsquo;cash on delivery&rsquo;
              to and from other Buyers in respect of transactions through Pay
              Facility.
            </li>
            <li>
              Your relationship with the Company is on a principal to principal
              basis and by accepting these Terms, You agree that the Company is
              an independent contractor for all purposes, and does not have
              control of or liability for the products or services that are
              listed on the Platform that are paid for by using the Pay
              Facility. The Company does not guarantee the identity of any Buyer
              nor does it ensure that a Buyer or a Merchant will complete a
              transaction.
            </li>
            <li>
              You understand, accept and agree that the Pay Facility provided by
              the Company is neither a banking nor financial service but is
              merely a facilitator providing an electronic, automated online
              electronic payment, receiving payment through &lsquo;cash on
              delivery&rsquo;, collection and remittance facility for the
              ...
              by providing the Pay Facility, the Company is neither acting as
              trustees nor acting in a fiduciary capacity with respect to the
              transaction or the transaction price.
            </li>
            <li>
              Buyers acknowledge and agree that the Company acts as the
              Merchant&apos;s payment agent for the limited purpose of accepting
              payments from Buyers on behalf of the Merchant. Upon Your payment
              of amounts to us, which are due to the Merchant, Your payment
              obligation to the Merchant for such amounts is completed, and we
              are responsible for remitting such amounts to the Merchant. You
              shall not, under any circumstances whatsoever, make any payment
              directly to the Merchant for Order bookings made using the
              Platform.
            </li>
            <li>
              ...
              <ol start="1" type="1">
                <li>
                  ...
                  contract with the Merchant to purchase the products and /or
                  services from the Merchant using the Pay Facility, and You
                  shall pay the transaction price through Your issuing bank to
                  the Merchant using Pay Facility.
                </li>
                <li>
                  You, as a Buyer, shall be entitled to claim a refund of the
                  transaction price from the Merchant (as Your sole and
                  exclusive remedy) in case You do not receive the delivery of
                  the goods or services being sold by the Merchant within the
                  time period agreed in the transaction. In case You do not
                  raise a refund claim using the Platform features within the
                  stipulated time, then this would make You ineligible for a
                  refund.
                </li>
                <li>
                  You, as a Buyer, understand that refund may not be available
                ...
                <li>
                  Except for &lsquo;cash on delivery&rsquo; transactions,
                  refund, if any, shall be made at the same issuing bank from
                  where the transaction price was received, or through any other
                  method available on the third party payment gateway&rsquo;s
                  website, as chosen by You.
                </li>
                <li>
                  For &lsquo;cash on delivery&rsquo; transactions, refunds, if
                  any, will be made via electronic payment transfers in
                  accordance with the policies adopted by the third party
                  payment gateway.
                </li>
                <li>
                ...
                <li>
                  ...
                  supported for processing refunds, You will be required to
                  share alternate bank account details with for processing the
                  refund.
                </li>
                <li>
                ...
                <li>
                  ...
                  facility authorized by Reserve Bank of India to provide
                ...
                <li>
                  The Company reserves the right to refuse to process
                ...
                <li>
                  ...
                  delay in processing a transaction/transaction price which is
            ...
            <li>
              ...
              <ol start="1" type="1">
                <li>
                  ...
                  1999 and the rules made and notifications issued thereunder
                  and the Exchange Control Manual as may be issued by Reserve
                  Bank of India from time to time, Customs Act, Information and
                  Technology Act, 2000 as amended by the Information Technology
                  (Amendment) Act 2008, Prevention of Money Laundering Act, 2002
                  and the rules made there under, Foreign Contribution
                  Regulation Act, 1976 and the rules made there under, Income
                  Tax Act, 1961 and the rules made there under, Export Import
                  Policy of government of India) applicable to them respectively
                  for using the payment facility.
                </li>
              </ol>
            </li>
            <li>
              ...
              <ol start="1" type="1">
                <li>
                  ...
                  instruments are processed using a payment gateway or
                  appropriate payment system infrastructure and the same will
                  also be governed by the terms and conditions agreed to between
                  the Buyer and the respective issuing bank and payment
                ...
                <li>
                  ...
                  bank which support Pay Facility to provide these services to
                  the Users. All such online bank transfers on Pay Facility are
      ...
      <p>
        ...
        information about outside services and resources offered by third
        parties, we do not give any express or implied warranties or guarantees
        regarding the content, services, and information provided on such linked
        websites. Any concerns regarding any such services or resources, or any
        link thereto, should be directed to the particular service or resource
        provider. We provide these links only for the convenience of visitors to
        the Platform. You can visit any and all of the linked websites entirely
        at your own discretion, however we shall assume no responsibility for
        the outcome of any such interactions.
      </p>
      <ol start="17" type="1">
        <li>
          ...
          <ol start="1" type="1">
            <li>
              In no event shall the Company or its Personnel or its suppliers,
              ...
              providers on behalf of the Platform or the Company or any other
              services.
            </li>
            <li>
              The Company&rsquo;s liability under all circumstances is limited
              to the amount of charges/ fees, if any, paid by You to the
              Company. The Company, its Personnel and internal service providers
              and technology partners make no representations or warranties
              about the accuracy, reliability, completeness, and/or timeliness
              of any information or communication provided on or through the use
              of the Platform or that of the operation of the Platform or Pay
              Facility will be error free and/or uninterrupted. The Company
              ...
              transmitted in connection with use of the Platform or Pay
              Facility; or (b) any delay, failure, interruption or errors in the
              operation of the Platform or Pay Facility.
            </li>
          </ol>
        </li>
        <li>
          <strong>Indemnity for non-compliance or breach</strong>
        </li>
      </ol>
      <p>
        ...
        paid in settlement and expenses (including without limitation
        attorneys&apos; fees and disbursements), made by any third party or
        penalty imposed due to or arising out of Your breach of the User
        Agreement or resulting from untrue, inaccurate, misleading not current
        or incomplete information provided or verified by You.
      </p>
      <ol start="19" type="1">
        <li>
          <strong>Consent and Privacy Policy</strong>
          <ol start="1" type="1">
            <li>
              ...
              the Company. The personal information / data including but not
            ...
            <li>
              The Company views the protection of User&rsquo;s privacy as a very
              important community principle. The Company clearly understands
              that You and the personal information provided by You is one of
              the most important assets to the Company. The Company stores and
              processes the information provided by You that are protected by
        ...
        <li>
          ...
          <ol start="1" type="1">
            <li>
              ...
              Company may at its sole discretion take such action as it deems
              fit including but not limited to cancellation of the membership
              and deletion of the account , limit Your activity on the Platform,
              ...
              between the Company and You in addition to these Terms, terms and
              conditions made thereunder which are incorporated therein by
              reference; any misuse of Youraccount or the Pay Facility (if
              utilised), in case the Company is unable to verify or authenticate
              any information provided by You, if the Company believes that Your
              actions may cause legal liability to the Company, other Users or
              Yourself.
            </li>
            <li>
              No actions, omissions or decisions taken by the Company shall
              waive any rights or claims that the Company may have against the
              User. Any User that may have been suspended or blocked may not
              register or attempt to register with the Platform or use the
              Platform in any manner whatsoever until such time that such User
              is reinstated by the Company. Notwithstanding the above, if You
              breach the Terms or the Policies and other documents incorporated
              therein by reference or any other agreements entered into by the
              Company and You in addition to the Terms, the Company reserves the
              right to take strict legal action including but not limited to
              referral to the appropriate police or other authorities for
        ...
        <li>
          ...
          <ol start="1" type="1">
            <li>
              ...
              Officer at{" "}
              <a href="mailto:support@navtatva.fashion">
                support@navtatva.fashion
              </a>{" "}
            ...
            <li>
              ...
              may remain unresolved. By agreeing to the Terms herein, you hereby
              consent and authorize the Grievance Officer to contact you on the
        ...
        <li>
          ...
          <ol start="1" type="1">
            <li>
              All communications between the You and the Company and all
              confidential information given to or received by You from the
              Company, and all information concerning the business transactions
              of the Company with any entity or person with whom it may or may
              not have a confidentiality obligation with regard to the matter in
              question, shall be kept confidential by You (whether or not such
              information or data has been marked as confidential) unless
              specifically permitted to the contrary in writing to the Company.
            </li>
            <li>
      ...
      <p>
        ...
        applicable Law, the remainder of the User Agreement and the application
        of such provision to persons or circumstances other than those as to
        which it is held invalid or unenforceable shall not be affected thereby,
        and each provision of the User Agreement shall be valid and enforceable
        to the fullest extent permitted by Law. Any invalid or unenforceable
        provision of the User Agreement shall be replaced with a provision,
        which is valid and enforceable and most nearly reflects the original
        ...
        <li>
          ...
          <ol start="1" type="1">
            <li>
              ...
              any dispute arises between You and the Company during Your use of
              the Platform or the Pay Facility or any service incidental to the
              Platform or thereafter, in connection with the validity,
              interpretation, implementation or alleged breach of any provision
              of the Terms and/or any other agreement between the Company and
              You in addition to the User Agreement and any other documents
              incorporated therein by reference, the dispute shall be referred
              to the senior management of the Company for conciliation. If the
              ...
              Karnataka and You hereby submit to the jurisdiction of such
              courts.
            </li>
          </ol>
        </li>
...
export default TermsCondition3;
